...
import { DETAIL_LOKASI_KERUSAKAN, DETAIL_POHON } from '@/lib/api'
...
import ModalUpdateLokasiKerusakan from './modal-update'
import ModalDeleteLokasiKerusakan from './modal-delete'
        ...
        <>
            <div className="flex gap-2 float-right">
                ...
                <Drawer open={modalOpen} onOpenChange={setModalOpen}>
                    {modalData && modalOpen && <ModalUpdateLokasiKerusakan data={modalData} onUpdateFinish={handleUpdateFinish} />}
                </Drawer>
                {/* Tombol delete */}
                ...
                <Drawer open={modalOpenDelete} onOpenChange={setModalOpenDelete}>
                    {modalOpenDeleteData && modalOpenDelete && <ModalDeleteLokasiKerusakan data={modalOpenDeleteData} onDeleteFinish={handleUpdateDelete} />}
                </Drawer>
            </div>
        </>
    );
