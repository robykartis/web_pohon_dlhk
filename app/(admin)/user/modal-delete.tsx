...
import { DELETE_USER } from '@/lib/api'
...
export default function ModalDelete({ data, onDeleteFinish, isDrawerOpenProp }: { data: UserType, onDeleteFinish: () => void, isDrawerOpenProp: boolean }) {
    const [isDrawerOpenLocal, setIsDrawerOpenLocal] = useState<boolean>(isDrawerOpenProp);
