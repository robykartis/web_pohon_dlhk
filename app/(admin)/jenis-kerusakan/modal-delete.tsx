...
import { DELETE_LOKASI_KERUSAKAN } from '@/lib/api'
...
export default function ModalDeleteLokasiKerusakan({ data }: { data: LokasiKerusakanType, onDeleteFinish: () => void }) {
