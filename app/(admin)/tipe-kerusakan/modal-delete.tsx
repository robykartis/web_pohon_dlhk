...
import { DELETE_TIPE_KERUSAKAN } from '@/lib/api'
...
export default function ModalDeleteTipeKerusakan({ data }: { data: TipeKerusakanType, onDeleteFinish: () => void }) {
        ...
        <DrawerContent>
            <div className="w-full space-y-4">
                <div className="mx-auto w-full max-w-lg">
                    ...
                    <DrawerFooter>
                        <Button disabled={pending} variant="destructive" onClick={handleDelete}>
                            {pending ? (
                                <>
